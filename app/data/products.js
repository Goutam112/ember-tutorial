...
},
{
  ...
  "description": "Take your gaming to the next level with PlayStation 5 slim console, with powerful features, like ray tracing, near-instant load times, and HDR technology.",
  "price": {
    "original": 649.95,
    "current": 519.98
  },
  "features": [
    "Ray tracing technology adds more detail and realism to every scene with true-to-life shadows and reflections",
    "1TB internal SSD provides ultrafast data handling speeds that significantly reduce loading times for the installed PS5 games",
    "Supports HDR technology for vibrant and natural looking colours on supported PS5 games",
    "Immersive gaming experience with adaptive triggers, realistic haptic feedback, and Tempest 3D Audio technology"
  ],
  "colors": [{
    "color": "white",
    "image": "/assets/images/ps5-slim.png"
  }]
},
];